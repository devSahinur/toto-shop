    ...
    return (
      ...
      <div className="container flex items-center justify-between">
          ...
          <div className="space-x-4 flex items-center text-center">
              <div onClick={() => router.push('/wishlist')} className="block text-center text-gray-700 cursor-pointer hover:text-primary transition relative">
                  <span
              ...
              <div onClick={() => router.push('/account')} className="block text-center cursor-pointer text-gray-700 hover:text-primary transition">
