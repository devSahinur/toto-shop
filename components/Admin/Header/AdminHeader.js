    ...
    <div className=" bg-gradient-to-t from-header400 to-header500 px-5 py-3 sticky top-0">
      ...
      <div className="flex items-center justify-between">
        ...
        <div
          ...
          className="cursor-pointer hidden md:block w-32"
        >
          <svg
            width="156"
            height="23"
        ...
        <div
          ...
          className="inline-flex md:hidden bg-white p-1 rounded-md shadow text-gray-400 cursor-pointer"
        >
        ...
        <div className="flex items-center space-x-3">
          {/* Right left search bar content */}
          <div className="hidden md:flex items-center space-x-3">
            <div className="text-gray-500 cursor-pointer bg-white p-2 rounded">
              <PlusIcon className="h-6" />
            </div>
            <div className="flex items-center bg-white p-2 px-4 rounded shadow-md space-x-3">
              ...
              <input
                ...
                type="text"
                placeholder="Search.."
                className="h-full outline-none text-gray-400"
              />

              <XIcon
                className={`h-6 text-gray-500 cursor-pointer transition-all ease-in-out ${
          ...
          {/* Right right accout others stuf */}
          <div className="flex items-center space-x-2">
            {/* crater invoice */}
            <div className="text-gray-100 flex items-center px-3 py-2 bg-[#9995E8] cursor-pointer rounded-md space-x-1 relative">
              <p
              ...
              {dropdown && (
                <div className="absolute top-[45px] z-50 bg-white -left-[75px] px-2 py-2 rounded-md border shadow-md w-[250px] animationFadein">
                  ...
                  <RightDropDown
                    id={1}
                    icon="C"
                    text="Crater Invoice, Inc."
                    active
                  />
                  <RightDropDown id={2} icon="A" text="Apcoa" />
                  <RightDropDown id={1} icon="D" text="Defarensitional" />
                  <RightDropDown id={1} icon="S" text="Sona feeds" />
                  {/* TODO: ad new category */}
                  <div className="flex items-center justify-center space-x-2 border-t-2 pt-2">
                    <PlusIcon className="h-5 text-header400" />
                    <p className="text-header400 text-sm pb-1">
                      Add new company
                    </p>
                  </div>
                </div>
            ...
            <div className="w-[30px] h-[30px]">
              <Image
                src="https://i.ibb.co/nrtYQ8c/default-avatar.jpg"
                width="100%"
                height="100%"
