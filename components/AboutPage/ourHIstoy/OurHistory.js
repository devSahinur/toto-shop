  ...
  return (
    <section className="grid grid-cols-1 xl:grid-cols-2 pt-10 px-3">
      ...
      <div className="md:pr-4 space-y-4">
        ...
        <h1
          className="text-3xl sm:text-4xl uppercase font-medium"
        ...
        >
          Fashion is a potent visual marker of our times,"says Caroilne
          Stevenson,head of cultural and... "Trend analysis of any given era
          will reveal society's values and aspirataions"... The urge to creative
          expression runs deep
        </p>
        {/* preview div */}
      ...
      <div className="w-full">
        ...
        <Image
          src="https://i.ibb.co/zH3WS4d/about-img.jpg"
