...
function EditProductImage({ handleImageUpload, images, imageRemoveControl }) {
  return (
    <div>
            ...
            <div className="text-center flex items-center flex-col justify-center h-[200px] rounded-md border-dashed border-2 text-gray-500 relative">
              {images.length >= 1 ? (
                <>
                  ...
                  />
                  <XIcon
                    onClick={() => imageRemoveControl(`${images[0]}`)}
            ...
            <div className="text-center flex items-center flex-col justify-center h-[200px] rounded-md border-dashed border-2 text-gray-500 relative">
              {images.length >= 2 ? (
                <>
                  ...
                  />
                  <XIcon
                    onClick={() => imageRemoveControl(`${images[1]}`)}
                    className="absolute top-0 right-0 h-5 cursor-pointer"
                  />
                </>
              ) : (
            ...
            <div className="text-center flex items-center flex-col justify-center h-[200px] rounded-md border-dashed border-2 text-gray-500 relative">
              {images.length >= 3 ? (
                <>
                  ...
                  />
                  <XIcon
                    onClick={() => imageRemoveControl(`${images[2]}`)}
                    className="absolute top-0 right-0 h-5 cursor-pointer"
                  />
                </>
              ) : (
            ...
            <div className="text-center flex items-center flex-col justify-center h-[200px] rounded-md border-dashed border-2 text-gray-500 relative">
              {images.length >= 4 ? (
                <>
                  ...
                  />
                  <XIcon
                    onClick={() => imageRemoveControl(`${images[3]}`)}
                    className="absolute top-0 right-0 h-5 cursor-pointer"
                  />
                </>
              ) : (
            ...
            <div className="text-center flex items-center flex-col justify-center h-[200px] rounded-md border-dashed border-2 text-gray-500 relative">
              {images.length >= 5 ? (
                <>
                  ...
                  />
                  <XIcon
                    onClick={() => imageRemoveControl(`${images[4]}`)}
                    className="absolute top-0 right-0 h-5 cursor-pointer"
                  />
                </>
              ) : (
